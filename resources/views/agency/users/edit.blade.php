		...
		<div class="row align-items-center">
			<div class="col">
				...
				<div class="text-muted mt-1">
					...
					@endif
					<span class="badge bg-azure">User</span>
				</div>
			</div>
			<!-- Page title actions -->
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="card mb-4" id="general">
					...
					<form action="{{ route('post_agency_users_edit', $user->id) }}" method="post">
						{{ csrf_field() }}
						<div class="card-body">
						...
						<div class="card-footer">
							<div class="d-flex">
								<a href="{{ route('get_agency_users_index') }}" class="btn btn-link">Cancel</a>
				...
				<div class="card mb-4" id="security">
					...
					<form action="{{ route('post_agency_users_password', ['id' => $user->id]) }}" method="post">
						{{ csrf_field() }}
						<div class="card-body">
				...
				<div class="card mb-4" id="extra">
					...
					<form action="{{ route('post_agency_users_bonus', ['id' => $user->id]) }}" method="post">
						{{ csrf_field() }}
						<div class="card-body">
